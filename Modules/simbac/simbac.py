###simulate phylogentic tre and sequences using SimBac

def get_options():
    import argparse

    description = 'simulate bacterial population using SimBac'
...
def simbac(num_species,genome_length,output,mutation_rate,r_i,r_e,random_seed,simbac_path):
...
simbac (options.num_species,options.genome_length,options.output,
